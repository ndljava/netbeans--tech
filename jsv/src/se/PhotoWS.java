...
public class PhotoWS {
    ...
    static class Photo_Service_rest_JerseyClient {

        private WebResource webResource;
        private Client client;
        private static final String BASE_URI = "http://api.flickr.com/";

        public Photo_Service_rest_JerseyClient() {
            com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
            client = Client.create(config);
            webResource = client.resource(BASE_URI).path("services/rest");
        }
         ...
         */
        public <T> T activity_userComments(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            ...
            return webResource.queryParams(getQueryOrFormParams(queryParamNames, queryParamValues)).queryParam("api_sig", signature).queryParams(getQParams(optionalQueryParams)).accept(javax.ws.rs.core.MediaType.TEXT_XML).get(responseType);
        }
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T activity_userPhotos(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T blogs_getList(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
            ...
            return webResource.queryParams(getQueryOrFormParams(queryParamNames, queryParamValues)).queryParam("api_sig", signature).accept(javax.ws.rs.core.MediaType.TEXT_XML).get(responseType);
        }
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T blogs_postPhoto(Class<T> responseType, String blog_id, String photo_id, String title, String description, String blog_password) throws UniformInterfaceException, IOException {
            ...
            return webResource.queryParam("api_sig", signature).type(javax.ws.rs.core.MediaType.APPLICATION_FORM_URLENCODED).post(responseType, getQueryOrFormParams(formParamNames, formParamValues));
        }
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T contacts_getList(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T contacts_getPublicList(Class<T> responseType, String user_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T favorites_add(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T favorites_getList(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T favorites_getPublicList(Class<T> responseType, String user_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "user_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T favorites_remove(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_browse(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_getInfo(Class<T> responseType, String group_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_search(Class<T> responseType, String text, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_pools_add(Class<T> responseType, String photo_id, String group_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_pools_getContext(Class<T> responseType, String photo_id, String group_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_pools_getGroups(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_pools_getPhotos(Class<T> responseType, String group_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "group_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T groups_pools_remove(Class<T> responseType, String photo_id, String group_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photo_id", "group_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T interestingness_getList(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_findByEmail(Class<T> responseType, String find_email) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_findByUsername(Class<T> responseType, String username) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_getInfo(Class<T> responseType, String user_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "user_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_getPublicGroups(Class<T> responseType, String user_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "user_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_getPublicPhotos(Class<T> responseType, String user_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "user_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T people_getUploadStatus(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_addTags(Class<T> responseType, String photo_id, String tags) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_delete(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getAllContexts(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getContactsPhotos(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getContactsPublicPhotos(Class<T> responseType, String user_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "user_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getContext(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getCounts(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getExif(Class<T> responseType, String photo_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getFavorites(Class<T> responseType, String photo_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getInfo(Class<T> responseType, String photo_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getNotInSet(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getPerms(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getRecent(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getSizes(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getUntagged(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getWithGeoData(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_getWithoutGeoData(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_recentlyUpdated(Class<T> responseType, String min_date, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_removeTag(Class<T> responseType, String tag_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_search(Class<T> responseType, String machine_tag_mode, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setContentType(Class<T> responseType, String photo_id, String content_type) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setDates(Class<T> responseType, String photo_id, String date_posted, String date_taken, String date_taken_granularity) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setMeta(Class<T> responseType, String photo_id, String title, String description) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setPerms(Class<T> responseType, String photo_id, String is_public, String is_friend, String is_family, String perm_comment, String perm_addmeta) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setSafetyLevel(Class<T> responseType, String photo_id, String safety_level, String hidden) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_setTags(Class<T> responseType, String photo_id, String tags) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photo_id", "tags", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_comments_addComment(Class<T> responseType, String photo_id, String comment_text) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_comments_deleteComment(Class<T> responseType, String comment_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_comments_editComment(Class<T> responseType, String comment_id, String comment_text) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_comments_getList(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_geo_getLocation(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_geo_getPerms(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_geo_removeLocation(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_geo_setLocation(Class<T> responseType, String photo_id, String lat, String lon, String accuracy) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_geo_setPerms(Class<T> responseType, String is_public, String is_contact, String is_friend, String is_family, String photo_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_licenses_getInfo(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_licenses_setLicense(Class<T> responseType, String photo_id, String license_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_notes_add(Class<T> responseType, String photo_id, String note_x, String note_y, String note_w, String note_h, String note_text) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_notes_delete(Class<T> responseType, String note_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_notes_edit(Class<T> responseType, String note_id, String note_x, String note_y, String note_w, String note_h, String note_text) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_transform_rotate(Class<T> responseType, String photo_id, String degrees) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photos_upload_checkTickets(Class<T> responseType, String tickets) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_addPhoto(Class<T> responseType, String photoset_id, String photo_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_create(Class<T> responseType, String title, String description, String primary_photo_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_delete(Class<T> responseType, String photoset_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_editMeta(Class<T> responseType, String photoset_id, String title, String description) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_editPhotos(Class<T> responseType, String photoset_id, String primary_photo_id, String photo_ids) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_getContext(Class<T> responseType, String photo_id, String photoset_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_getInfo(Class<T> responseType, String photoset_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_getList(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_getPhotos(Class<T> responseType, String photoset_id, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photoset_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_orderSets(Class<T> responseType, String photoset_ids) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_removePhoto(Class<T> responseType, String photoset_id, String photo_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "photoset_id", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_comments_addComment(Class<T> responseType, String photoset_id, String comment_text) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_comments_deleteComment(Class<T> responseType, String comment_id) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "comment_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_comments_editComment(Class<T> responseType, String comment_id, String comment_text) throws UniformInterfaceException, IOException {
            String[] formParamNames = new String[]{"api_key", "comment_id", "comment_text", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T photosets_comments_getList(Class<T> responseType, String photoset_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photoset_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T places_find(Class<T> responseType, String query) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T places_findByLatLon(Class<T> responseType, String lat, String lon, String... optionalQueryParams) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T places_resolvePlaceId(Class<T> responseType, String place_id) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T places_resolvePlaceURL(Class<T> responseType, String url) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T prefs_getContentType(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T prefs_getHidden(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T prefs_getPrivacy(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T prefs_getSafetyLevel(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T reflection_getMethodInfo(Class<T> responseType, String method_name) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T reflection_getMethods(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getHotList(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getListPhoto(Class<T> responseType, String photo_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "photo_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getListUser(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getListUserPopular(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getListUserRaw(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
            String[] queryParamValues = new String[]{getApiKey(), getAuthToken(), "flickr.tags.getListUserRaw"};
            String signature = signParams(queryParamNames, queryParamValues, optionalQueryParams);
            return webResource.queryParams(getQueryOrFormParams(queryParamNames, queryParamValues)).queryParam("api_sig", signature).queryParams(getQParams(optionalQueryParams)).get(responseType);
        }
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T tags_getRelated(Class<T> responseType, String tag) throws UniformInterfaceException, IOException {
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T test_echo(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
            String[] queryParamValues = new String[]{getApiKey(), getAuthToken(), "flickr.test.echo"};
            String signature = signParams(queryParamNames, queryParamValues);
            return webResource.queryParams(getQueryOrFormParams(queryParamNames, queryParamValues)).queryParam("api_sig", signature).get(responseType);
        }
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T test_login(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T test_null(Class<T> responseType) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T urls_getGroup(Class<T> responseType, String group_id) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "group_id", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T urls_getUserPhotos(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T urls_getUserProfile(Class<T> responseType, String... optionalQueryParams) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T urls_lookupGroup(Class<T> responseType, String url) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "url", "auth_token", "method"};
         ...
         * @return response object (instance of responseType class)
         */
        public <T> T urls_lookupUser(Class<T> responseType, String url) throws UniformInterfaceException, IOException {
            String[] queryParamNames = new String[]{"api_key", "url", "auth_token", "method"};
        ...
        public void login(String api_key, String application_secret) throws IOException {
        ...
        private String getFrob() throws IOException {
            ...
            if (javax.swing.JOptionPane.showInputDialog(null, "Please log into your Flickr account using the following URL to authorize this application and click OK after you are done:", "Flickr Authorization Dialog", javax.swing.JOptionPane.INFORMATION_MESSAGE, null, null, loginUrl) == null) {
                throw new IOException("Authorizatoin declined");
            }
            return frob;
        }

        private String signParams(String[] paramNames, String[] paramValues, String[] optionalParams) throws IOException {
        ...
        private String signParams(String[] paramNames, String[] paramValues) throws IOException {
